...
var shake = stamina_buildup/stamina_max*2;

image_speed *= (gamefreeze==0);
draw_shadow();
draw_sprite_ext(sprite_index,image_index,x+random_range(-shake,shake),y+offset+random_range(-shake,shake),1,1,movement_angle*10,c_white,1);